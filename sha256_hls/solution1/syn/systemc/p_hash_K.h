...
// ==============================================================
#ifndef __p_hash_K_H__
#define __p_hash_K_H__
...
struct p_hash_K_ram : public sc_core::sc_module {
...
p_hash_K_ram* meminst;


SC_CTOR(p_hash_K) {
meminst = new p_hash_K_ram("p_hash_K_ram");
