...
set Interfaces {
    s_axi_ctrl_bus {
        ...
        registers {{0x10 msg W 0x0 "Data signal of msg" {{0 32 msg W 0 "Bit 31 to 0 Data signal of msg"}}} {0x18 len W 0x0 "Data signal of len" {{0 32 len W 0 "Bit 31 to 0 Data signal of len"}}} {0x20 hash W 0x0 "Data signal of hash" {{0 32 hash W 0 "Bit 31 to 0 Data signal of hash"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 308 II x}
