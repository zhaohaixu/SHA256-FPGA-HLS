...
architecture rtl of p_hash_K_rom is 
...
architecture arch of p_hash_K is
    component p_hash_K_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    p_hash_K_rom_U :  component p_hash_K_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
